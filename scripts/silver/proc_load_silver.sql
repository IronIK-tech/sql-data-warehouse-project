...
BEGIN 
   DECLARE @start_time DATETIME, @end_time DATETIME, @batch_start_time DATETIME, @batch_end_time DATETIME;
    BEGIN TRY 
        ...
        PRINT '>> Inseritng Data Into: silver.crm_prd_info';
        ...
        PRINT '>> Inseritng Data Into: silver.crm_sales_details';
        ...
        PRINT '>> Inseritng Data Into: silver.erp_cust_az12';
        ...
        FROM (
            SELECT
                cid,
                bdate,
                TRIM(REPLACE(REPLACE(gen, CHAR(13), ''), CHAR(10), '')) AS gen
        ...
        PRINT '>> Inseritng Data Into: silver.erp_loc_a101';
        ...
        PRINT '>> Inseritng Data Into: silver.erp_px_cat_g1v2';
